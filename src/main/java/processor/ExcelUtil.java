package postman2excel.processor;
...
public class ExcelUtil {
    ...
    public static <T> void exportExcel(String[] headers, Collection<T> dataset, OutputStream out,
        ...
        hssfSheet.setColumnWidth(9,12000);
        write2Sheet(hssfSheet, headers, cellStyle,dataset, pattern);
    ...
    public static <T> void exportExcel(List<ExcelSheet<T>> sheets, OutputStream out, String pattern) {
        ...
        for (ExcelSheet<T> sheet : sheets) {
            ...
            write2Sheet(hssfSheet, sheet.getHeaders(), cellStyle,sheet.getDataset(), pattern);
            hssfSheet.setColumnWidth(0,3000);
            hssfSheet.setColumnWidth(1,3000);
            hssfSheet.setColumnWidth(2,3000);
            hssfSheet.setColumnWidth(3,3000);
     ...
     * @param pattern 日期格式
     */
    private static <T> void write2Sheet(XSSFSheet sheet, String[] headers, XSSFCellStyle cellStyle, Collection<T> dataset,
                                        String pattern) {
        // 产生表格标题行
